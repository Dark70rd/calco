      ...
      body: SingleChildScrollView(
        ...
        child: RichText(
          text: TextSpan(
            ...
            children: [
              TextSpan(
                text: 'These terms and conditions applies to the Calco app'
                    ' (hereby referred to as "Application") for mobile devices'
                    ' that was created by mrx (hereby referred to as "Service Provider")'
                    ' as an Open Source service.\n\n',
              ),
              TextSpan(
                text: 'Upon downloading or utilizing the Application,'
                    ' you are automatically agreeing to the following terms.'
                    ' It is strongly advised that you thoroughly read and understand'
                    ' these terms prior to using the Application. Unauthorized copying,'
                    ' modification of the Application, any part of the Application,'
                    ' or our trademarks is strictly prohibited. Any attempts to extract'
                    ' the source code of the Application, translate the Application into'
              ...
              TextSpan(
                text: 'The Application stores and processes personal data that'
                    ' you have provided to the Service Provider in order to'
                    ' provide the Service. It is your responsibility to'
                    ' maintain the security of your phone and access to'
                    ' the Application. The Service Provider strongly advise'
                    ' against jailbreaking or rooting your phone, which involves'
                    ' removing software restrictions and limitations imposed by'
                    ' the official operating system of your device. Such actions'
                    ' could expose your phone to malware, viruses, malicious programs,'
                    ' compromise your phone\'s security features, and may result in'
                    ' the Application not functioning correctly or at all.\n\n',
              ),
              TextSpan(
                text: 'Please note that the Application utilizes third-party'
                    ' services that have their own Terms and Conditions.'
                    ' Below are the links to the Terms and Conditions of'
              ...
              TextSpan(
                text:
                    ...
                    ' accept responsibility for any such charges, including roaming data charges if you'
                    ' use the application outside of your home territory (i.e., region or country) without'
                    ' disabling data roaming. If you are not the bill payer for the device on which you'
              ...
              TextSpan(
                text:
                    ...
                    ' to note that while they strive to ensure that it is updated and accurate at all times,'
              ...
              TextSpan(
                text:
                    ...
                    ' need to download the updates if you want to continue using the application. The Service'
                    ' Provider does not guarantee that it will always update the application so that it is relevant'
              ...
              TextSpan(
                text:
                    ...
                    ' to contact the Service Provider at Calco@support.uk.\n\n',
              ),
              TextSpan(
                text:
